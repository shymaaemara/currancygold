...
class UserCurrencyDetails extends StatefulWidget {
  String category;
  UserCurrencyDetails({required this.category});

  @override
  State<UserCurrencyDetails> createState() => _UserCurrencyDetailsState();
}

class _UserCurrencyDetailsState extends State<UserCurrencyDetails> {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("اسعار ${widget.category}"),
