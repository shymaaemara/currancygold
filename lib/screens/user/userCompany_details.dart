...
class UserCompanyDetails extends StatefulWidget {
  String category;
  UserCompanyDetails({required this.category});

  @override
  State<UserCompanyDetails> createState() => _UserCompanyDetailsState();
}

class _UserCompanyDetailsState extends State<UserCompanyDetails> {
